...
#define LCD_NAME   "lcd_ft8057p_ld_mipi_hd"
/*****************************************************************************
...
static int fts_ts_probe(struct spi_device *spi)
{
    ...
    tp_interface.headset_switch_status = set_ft_tp_headset_state;
    tp_interface.charger_mode_switch_status = set_ft_tp_charger_state;
    tp_interface.tp_type = FT8057P;
...
static const struct of_device_id fts_dt_match[] = {
    {.compatible = "focaltech,fts-modules", },
    {},
};
