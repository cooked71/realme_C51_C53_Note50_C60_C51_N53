...
*****************************************************************************/
#define FTS_DRIVER_PEN_NAME                 "fts_ts,pen-modules"
...
//xiazhiping@BSP.TP.Function add for suspend start 2023.12.28 start
...
//xiazhiping@BSP.TP.Function add for suspend start 2023.12.28 end
...
static int fb_notifier_callback(struct notifier_block *self, unsigned long event, void *v)
{
    ...
    FTS_FUNC_ENTER();
    if (ts_data && v) {
#if (defined CONFIG_DRM && defined REPORT_NOTIFIER)
...
#elif (defined CONFIG_FB  && defined REPORT_NOTIFIER)
...
//xiazhiping@BSP.TP.Function add for suspend start 2023.12.28 start
    ...
    if (ret) {
        FTS_ERROR("create sysfs  node for suspend fail");
    }
//xiazhiping@BSP.TP.Function add for suspend start 2023.12.28 end
